 ...
 * @final
 */
export class NetworkFunctionCardController {
  /**
   * @ngInject
   */
  constructor() {
...
/**
 * Definition object for the component that displays a network function card.
 *
 * @type {!angular.Component}
 */
export const networkFunctionCardComponent = {
