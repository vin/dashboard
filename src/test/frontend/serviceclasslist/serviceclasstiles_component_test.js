...
describe('Service card controller', () => {
  /**
   * @type {!serviceclasslist/serviceclasstiles_component.ServiceClassTilesController}
   */
  let $ctrl;
  ...
  beforeEach(() => {
    ...
    angular.mock.inject(($componentController) => {
      $ctrl =
          $componentController('kdServiceClassTiles', {}, {serviceClassList, serviceBrokerList});
    });
  });
